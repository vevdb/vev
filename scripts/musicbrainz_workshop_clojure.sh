...
clojure \
  ...
  -M -e "(require '[musicbrainz-workshop :as workshop]) (println (workshop/validate-opening-bindings!)) (println (workshop/validate-find-specifications!)) (println (workshop/validate-basic-aggregations!)) (println (workshop/validate-deeper-query-intro!)) (println (workshop/validate-pre-1970-release-stats!)) (println (workshop/validate-pre-1970-track-stats!)) (println (workshop/validate-rules-intro!)) (println (workshop/validate-pattern-inputs!)) (println (workshop/validate-pull-intro!)) (println (workshop/validate-pull-nested-map!)) (println (workshop/validate-pull-wildcard!)) (println (workshop/validate-pull-wildcard-map!))"
