...
the query-stats tutorial traversal, and top-n aggregates. The next larger step
is continuing Day-of-Datomic host/tutorial snippets before doing more planner
work. See
