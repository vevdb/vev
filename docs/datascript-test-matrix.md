...
| `parser_rules.cljc` | 3 | partial | ordinary and source-qualified rule calls, rule definitions, ordered text rule bodies, and rule-body `get-else`/`get-some` covered; validation remains |
