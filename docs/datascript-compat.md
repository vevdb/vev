...
| --- | --- | --- |
| `query` | partial | DataScript join subset ported; inputs, plain int entity inputs, collection/tuple/relation bindings, named relation source joins, `_` input placeholders, and constant-substitution subset covered |
