...
| `pull_parser` | partial | Kvist pull literals and query text pull finds cover attrs, wildcard, nested map patterns, and flat `:default`/`:as`/`:limit` option vectors; nested attr-expr/options parser missing |
