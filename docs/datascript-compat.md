...
| `pull_api` | partial | Attrs, wildcard, reverse refs, nesting, pull-many, explicit/default limits, and forward component expansion covered; recursion and reverse component pull behavior missing |
