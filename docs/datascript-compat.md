...
| `validation` | partial | Nil value rejection plus value type, uniqueness, component schema, schema boolean attrs, schema keyword enum attrs, and cardinality subsets covered; bad transaction forms and exact validation errors incomplete |
