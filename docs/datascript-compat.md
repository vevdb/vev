...
| `validation` | partial | Nil value rejection plus value type, uniqueness, component schema, and cardinality subsets covered; bad transaction forms and exact validation errors incomplete |
