...
| `upsert` | partial | Unique-identity map/list tempid upsert and unique-ref numeric/lookup-ref upsert subsets covered; conflict reporting and intermediate-db retries incomplete |
