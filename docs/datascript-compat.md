...
| `query_rules` | partial | Literal rule input subset started: non-recursive rules with data clauses, predicates, `ground`, and built-in function clauses; recursive/mutual rules, rule sources, and validation incomplete |
