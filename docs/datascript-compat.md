...
| `transact` | partial | Add/retract/map forms, incoming-ref cleanup on retractEntity, ref-typed numeric value resolution, cardinality-one/unique replacement, and CAS one/many/nil/lookup-ref value subset covered; tx fn call, intermediate-DB tx resolution, and unschematized default cardinality-one incomplete |
...
| `lookup_refs` | partial | Lookup refs covered in query entity/value positions, pull, tx entity/value/CAS entity/expected/value positions, and missing-ref retract no-ops for entity and value refs; input lookup refs incomplete |
