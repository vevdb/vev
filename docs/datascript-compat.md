...
| `parser_*` | partial | Minimal query text API parses `[:find ... :where ...]` with simple data clauses and lowers to the same `Query` representation; full EDN, predicates/functions, pull, rules, and validation remain |
