...
| `components` | partial | Component `retractEntity`, `retractAttribute`, forward pull expansion, and explicit reverse pull subsets covered; entity/touch and exact reverse scalar shape missing |
