...
| `query_fns` | partial | DataScript subset ported for predicates, mixed-type predicate comparison, `ground`, `get-else`, `get-some`, and `missing?`; arbitrary host/function clauses missing |
