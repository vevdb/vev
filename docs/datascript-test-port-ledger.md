...
| `query_pull.cljc` | 8 | subset | basic, variable-pattern, text pattern-variable, aggregate, lookup-ref pull, multi-source pull, and scalar/collection/tuple pull find-spec shapes covered; exact Clojure return rendering remains |
