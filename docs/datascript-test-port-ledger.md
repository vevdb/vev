...
| `query_not.cljc` | 5 | subset | relation and DB source-prefixed forms, nested inherited/override source, checked unbound-group errors, and query-text source-order top-level `not` validation covered; literal macro/rule-body order remains |
