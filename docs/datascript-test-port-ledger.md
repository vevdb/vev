...
| `parser*.cljc` | 19 | partial | query text subset parses relation/collection find plus data, predicate, and built-in function where clauses; full EDN not/or, pull, rules, and validation remain |
