...
| `query_or.cljc` | 5 | subset | relation and DB source-prefixed forms, nested inherited/override source, plain-`or` branch var matching, and `or-join` projection validation covered; nested binding-form validation and exact diagnostics remain |
