...
| `parser*.cljc` | 19 | partial | query text subset parses relation/collection find plus data, predicate, built-in function, missing?, not, and or where clauses; full EDN pull, rules, and validation remain |
