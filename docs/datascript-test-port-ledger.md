...
| `query_rules.cljc` | 3 | subset | source-qualified relation rule calls, repeated rule calls, fixpoint/symmetric recursion, and literal/text rule body source order covered; host predicate inputs, validation, and semi-naive performance remain |
