...
| `query_rules.cljc` | 3 | subset | source-qualified relation rule calls, repeated rule calls, fixpoint/symmetric recursion, literal/text rule body source order, and unknown/arity/param validation covered; host predicate inputs and semi-naive performance remain |
